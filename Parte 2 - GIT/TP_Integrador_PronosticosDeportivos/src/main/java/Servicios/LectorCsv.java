...
public class LectorCsv {
    ...
    public static List<Partido> leerArchivoResultados(String resultadosArchivo, List<Partido> partidos, List<Ronda> rondas){
    ...
    public static List<Participante> leerArchivoPronosticosParticipantes (String pronosticosArchivo2, List<Participante> participantes){
